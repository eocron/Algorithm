...
{
    public sealed class RsaSerializationConverter : ISerializationConverter
    {
        ...
        public RsaSerializationConverter(ISerializationConverter inner, X509Certificate2 cert, ArrayPool<byte> pool = null)
        {
