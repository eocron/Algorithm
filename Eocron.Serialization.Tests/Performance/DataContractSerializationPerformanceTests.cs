...
{
    public class DataContractSerializationPerformanceTests : SerializationPerformanceTestsBase<DataContractSerializationPerformanceTests, XmlTestModelFooBar>, ISerializationPerformanceTests
    {
        [Benchmark()]
