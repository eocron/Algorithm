...
namespace Eocron.Algorithms.Streams
{
    public static class StringStreamExtensions
    {
        public static async IAsyncEnumerable<T> AsAsyncEnumerable<T>(this IEnumerable<T> enumerable)
        {
            ...
            foreach (var e in enumerable) yield return e;
        }
        ...
        public static string BuildString(this IEnumerable<Memory<char>> enumerable)
        {
            ...
            foreach (var memory in enumerable) sb.Append(memory.Span);
            return sb.ToString();
        }

        public static async Task<string> BuildStringAsync(this IAsyncEnumerable<Memory<char>> enumerable,
        ...
        public static async IAsyncEnumerable<Memory<char>> Convert(this IAsyncEnumerable<Memory<byte>> enumerable,
            Encoding encoding)
        {
            if (enumerable == null)
                throw new ArgumentNullException(nameof(enumerable));
        ...
        public static async IAsyncEnumerable<Memory<byte>> Convert(this IAsyncEnumerable<Memory<char>> enumerable,
            Encoding encoding)
        {
            if (enumerable == null)
                throw new ArgumentNullException(nameof(enumerable));
