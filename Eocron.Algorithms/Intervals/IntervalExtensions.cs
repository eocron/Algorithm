...
namespace Eocron.Algorithms.Intervals
{
    public static class Interval
    {
        ...
        /// <returns></returns>
        public static IEnumerable<Interval<T>> Complement<T>(this Interval<T> interval,
        ...
        public static bool Contains<T>(this Interval<T> interval, IntervalPoint<T> value,
            IComparer<IntervalPoint<T>> comparer = null)
        {
            comparer ??= IntervalPointComparer<T>.Default;
        ...
        public static IEnumerable<Interval<T>> Difference<T>(this Interval<T> a, Interval<T> b,
            IComparer<IntervalPoint<T>> comparer = null)
        {
            comparer ??= IntervalPointComparer<T>.Default;
        ...
        /// <param name="comparer"></param>
        /// <returns></returns>
        public static IEnumerable<Interval<T>> Intersection<T>(this IEnumerable<Interval<T>> intervals,
            IComparer<IntervalPoint<T>> comparer = null)
        {
            comparer ??= IntervalPointComparer<T>.Default;
            if (intervals == null)
        ...
        {
            comparer ??= IntervalPointComparer<T>.Default;
            return (comparer.Compare(a.StartPoint, b.EndPoint) == 0 &&
                    a.StartPoint.IsGougedOut ^ b.EndPoint.IsGougedOut) ||
                   (comparer.Compare(a.EndPoint, b.StartPoint) == 0 &&
                    a.EndPoint.IsGougedOut ^ b.StartPoint.IsGougedOut);
        }
        ...
        /// <param name="comparer"></param>
        /// <returns></returns>
        public static IEnumerable<Interval<T>> Union<T>(this IEnumerable<Interval<T>> intervals,
            IComparer<IntervalPoint<T>> comparer = null)
        {
            comparer ??= IntervalPointComparer<T>.Default;
            if (intervals == null)
            ...
            var orderedIntervals =
                intervals.OrderBy(x => x.StartPoint, new IntervalGougedPointComparer<T>(comparer, true));
