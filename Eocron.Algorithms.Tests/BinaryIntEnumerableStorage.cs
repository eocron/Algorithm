...
namespace Eocron.Algorithms.Tests
{
    ...
    {
        public BinaryIntEnumerableStorage(string tempFolder = null, bool useCompress = true) : base(tempFolder,
            useCompress)
        {
        }
        ...
        protected override IEnumerable<int> DeserializeFromStream(Stream inputStream)
        {
            ...
            for (var i = 0; i < count; i++) yield return br.ReadInt32();
        }
        ...
        protected override void SerializeToStream(IReadOnlyCollection<int> data, Stream outputStream)
        {
            ...
            bw.Write(data.Count);
            foreach (var i in data) bw.Write(i);
            bw.Flush();
        }
    }
}